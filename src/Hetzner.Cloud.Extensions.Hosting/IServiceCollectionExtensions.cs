...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddHetznerCloud(this IServiceCollection services, Action<HostConfiguration> options)
    {
        HostConfiguration config = new(services);
        options(config);
        AddHetznerCloud(services, config);
    }

    internal static void AddHetznerCloud(IServiceCollection services, HostConfiguration host)
    {
        if (!host.HttpClientsAdded)
            host.AddHetznerCloudHttpClients();
