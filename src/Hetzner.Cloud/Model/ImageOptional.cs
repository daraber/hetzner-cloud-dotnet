...
namespace Hetzner.Cloud.Model
{
    ...
    /// </summary>
    internal partial class ImageOptional : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageOptional" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        internal ImageOptional(Architecture architecture, string created, string description, decimal diskSize, long id, Dictionary<string, string> labels, OsFlavorEnum osFlavor, Protection protection, StatusEnum status, TypeEnum type, long? boundTo = default, CreatedFrom? createdFrom = default, string? deleted = default, string? deprecated = default, decimal? imageSize = default, string? name = default, string? osVersion = default, Option<bool?> rapidDeploy = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ImageOptional" />
    /// </summary>
    internal class ImageOptionalJsonConverter : JsonConverter<ImageOptional>
    {
        /// <summary>
        /// Deserializes json to <see cref="ImageOptional" />
        /// </summary>
        ...
        public override ImageOptional Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ImageOptional.OsFlavorEnum?> osFlavor = default;
            Option<Protection?> protection = default;
            Option<ImageOptional.StatusEnum?> status = default;
            Option<ImageOptional.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "os_flavor":
                            ...
                            if (osFlavorRawValue != null)
                                osFlavor = new Option<ImageOptional.OsFlavorEnum?>(ImageOptional.OsFlavorEnumFromStringOrDefault(osFlavorRawValue));
                            break;
                        case "protection":
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<ImageOptional.StatusEnum?>(ImageOptional.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "type":
                            string? typeRawValue = utf8JsonReader.GetString();
                            if (typeRawValue != null)
                                type = new Option<ImageOptional.TypeEnum?>(ImageOptional.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "bound_to":
            ...
            if (!architecture.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(architecture));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(created));

            if (!description.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(description));

            if (!diskSize.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(diskSize));

            if (!id.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(id));

            if (!labels.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(labels));

            if (!osFlavor.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(osFlavor));

            if (!protection.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(protection));

            if (!status.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(status));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(type));

            if (!boundTo.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(boundTo));

            if (!createdFrom.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(createdFrom));

            if (!deleted.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(deleted));

            if (!deprecated.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(deprecated));

            if (!imageSize.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(imageSize));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(name));

            if (!osVersion.IsSet)
                throw new ArgumentException("Property is required for class ImageOptional.", nameof(osVersion));

            if (architecture.IsSet && architecture.Value == null)
                throw new ArgumentNullException(nameof(architecture), "Property is not nullable for class ImageOptional.");

            if (created.IsSet && created.Value == null)
                throw new ArgumentNullException(nameof(created), "Property is not nullable for class ImageOptional.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class ImageOptional.");

            if (diskSize.IsSet && diskSize.Value == null)
                throw new ArgumentNullException(nameof(diskSize), "Property is not nullable for class ImageOptional.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ImageOptional.");

            if (labels.IsSet && labels.Value == null)
                throw new ArgumentNullException(nameof(labels), "Property is not nullable for class ImageOptional.");

            if (osFlavor.IsSet && osFlavor.Value == null)
                throw new ArgumentNullException(nameof(osFlavor), "Property is not nullable for class ImageOptional.");

            if (protection.IsSet && protection.Value == null)
                throw new ArgumentNullException(nameof(protection), "Property is not nullable for class ImageOptional.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class ImageOptional.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ImageOptional.");

            if (rapidDeploy.IsSet && rapidDeploy.Value == null)
                throw new ArgumentNullException(nameof(rapidDeploy), "Property is not nullable for class ImageOptional.");

            return new ImageOptional(architecture.Value!.Value!, created.Value!, description.Value!, diskSize.Value!.Value!, id.Value!.Value!, labels.Value!, osFlavor.Value!.Value!, protection.Value!, status.Value!.Value!, type.Value!.Value!, boundTo.Value!, createdFrom.Value!, deleted.Value!, deprecated.Value!, imageSize.Value!, name.Value!, osVersion.Value!, rapidDeploy);
        }

        /// <summary>
        /// Serializes a <see cref="ImageOptional" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="imageOptional"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ImageOptional imageOptional, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, imageOptional, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ImageOptional" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="imageOptional"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ImageOptional imageOptional, JsonSerializerOptions jsonSerializerOptions)
        {
            if (imageOptional.Created == null)
                throw new ArgumentNullException(nameof(imageOptional.Created), "Property is required for class ImageOptional.");

            if (imageOptional.Description == null)
                throw new ArgumentNullException(nameof(imageOptional.Description), "Property is required for class ImageOptional.");

            if (imageOptional.Labels == null)
                throw new ArgumentNullException(nameof(imageOptional.Labels), "Property is required for class ImageOptional.");

            if (imageOptional.Protection == null)
                throw new ArgumentNullException(nameof(imageOptional.Protection), "Property is required for class ImageOptional.");

            var architectureRawValue = ArchitectureValueConverter.ToJsonValue(imageOptional.Architecture);
            writer.WriteString("architecture", architectureRawValue);

            writer.WriteString("created", imageOptional.Created);

            writer.WriteString("description", imageOptional.Description);

            writer.WriteNumber("disk_size", imageOptional.DiskSize);

            writer.WriteNumber("id", imageOptional.Id);

            writer.WritePropertyName("labels");
            JsonSerializer.Serialize(writer, imageOptional.Labels, jsonSerializerOptions);
            var osFlavorRawValue = ImageOptional.OsFlavorEnumToJsonValue(imageOptional.OsFlavor);
            writer.WriteString("os_flavor", osFlavorRawValue);
            writer.WritePropertyName("protection");
            JsonSerializer.Serialize(writer, imageOptional.Protection, jsonSerializerOptions);
            var statusRawValue = ImageOptional.StatusEnumToJsonValue(imageOptional.Status);
            writer.WriteString("status", statusRawValue);
            var typeRawValue = ImageOptional.TypeEnumToJsonValue(imageOptional.Type);
            writer.WriteString("type", typeRawValue);
            if (imageOptional.BoundTo != null)
                writer.WriteNumber("bound_to", imageOptional.BoundTo.Value);
            else
                writer.WriteNull("bound_to");

            if (imageOptional.CreatedFrom != null)
            {
                writer.WritePropertyName("created_from");
                JsonSerializer.Serialize(writer, imageOptional.CreatedFrom, jsonSerializerOptions);
            }
            else
                writer.WriteNull("created_from");
            if (imageOptional.Deleted != null)
                writer.WriteString("deleted", imageOptional.Deleted);
            else
                writer.WriteNull("deleted");

            if (imageOptional.Deprecated != null)
                writer.WriteString("deprecated", imageOptional.Deprecated);
            else
                writer.WriteNull("deprecated");

            if (imageOptional.ImageSize != null)
                writer.WriteNumber("image_size", imageOptional.ImageSize.Value);
            else
                writer.WriteNull("image_size");

            if (imageOptional.Name != null)
                writer.WriteString("name", imageOptional.Name);
            else
                writer.WriteNull("name");

            if (imageOptional.OsVersion != null)
                writer.WriteString("os_version", imageOptional.OsVersion);
            else
                writer.WriteNull("os_version");

            if (imageOptional.RapidDeployOption.IsSet)
                writer.WriteBoolean("rapid_deploy", imageOptional.RapidDeployOption.Value!.Value);
        }
    }

    /// <summary>
    /// The ImageOptionalSerializationContext
    /// </summary>
    [JsonSourceGenerationOptions(WriteIndented = true, GenerationMode = JsonSourceGenerationMode.Metadata | JsonSourceGenerationMode.Serialization)]
    [JsonSerializable(typeof(ImageOptional))]
    internal partial class ImageOptionalSerializationContext : JsonSerializerContext { }
}
