...
namespace Hetzner.Cloud.Model
{
    ...
    internal partial class ReplaceFirewallRequest : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplaceFirewallRequest {\n");
    ...
    internal class ReplaceFirewallRequestJsonConverter : JsonConverter<ReplaceFirewallRequest>
    {
        ...
        public override ReplaceFirewallRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (labels.IsSet && labels.Value == null)
                throw new ArgumentNullException(nameof(labels), "Property is not nullable for class ReplaceFirewallRequest.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ReplaceFirewallRequest.");

            return new ReplaceFirewallRequest(labels, name);
        }

        /// <summary>
        /// Serializes a <see cref="ReplaceFirewallRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="replaceFirewallRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReplaceFirewallRequest replaceFirewallRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, replaceFirewallRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReplaceFirewallRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="replaceFirewallRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReplaceFirewallRequest replaceFirewallRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (replaceFirewallRequest.LabelsOption.IsSet && replaceFirewallRequest.Labels == null)
                throw new ArgumentNullException(nameof(replaceFirewallRequest.Labels), "Property is required for class ReplaceFirewallRequest.");

            if (replaceFirewallRequest.NameOption.IsSet && replaceFirewallRequest.Name == null)
                throw new ArgumentNullException(nameof(replaceFirewallRequest.Name), "Property is required for class ReplaceFirewallRequest.");

            if (replaceFirewallRequest.LabelsOption.IsSet)
            {
                writer.WritePropertyName("labels");
                JsonSerializer.Serialize(writer, replaceFirewallRequest.Labels, jsonSerializerOptions);
            }
            if (replaceFirewallRequest.NameOption.IsSet)
                writer.WriteString("name", replaceFirewallRequest.Name);
        }
    }

    /// <summary>
    /// The ReplaceFirewallRequestSerializationContext
    /// </summary>
