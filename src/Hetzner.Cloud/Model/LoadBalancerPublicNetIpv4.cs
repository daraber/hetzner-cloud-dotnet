...
namespace Hetzner.Cloud.Model
{
    ...
    internal partial class LoadBalancerPublicNetIpv4 : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoadBalancerPublicNetIpv4 {\n");
    ...
    internal class LoadBalancerPublicNetIpv4JsonConverter : JsonConverter<LoadBalancerPublicNetIpv4>
    {
        ...
        public override LoadBalancerPublicNetIpv4 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new LoadBalancerPublicNetIpv4(dnsPtr, ip);
        }

        /// <summary>
        /// Serializes a <see cref="LoadBalancerPublicNetIpv4" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="loadBalancerPublicNetIpv4"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LoadBalancerPublicNetIpv4 loadBalancerPublicNetIpv4, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, loadBalancerPublicNetIpv4, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LoadBalancerPublicNetIpv4" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="loadBalancerPublicNetIpv4"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, LoadBalancerPublicNetIpv4 loadBalancerPublicNetIpv4, JsonSerializerOptions jsonSerializerOptions)
        {
            if (loadBalancerPublicNetIpv4.DnsPtrOption.IsSet)
                if (loadBalancerPublicNetIpv4.DnsPtrOption.Value != null)
                    writer.WriteString("dns_ptr", loadBalancerPublicNetIpv4.DnsPtr);
                else
                    writer.WriteNull("dns_ptr");

            if (loadBalancerPublicNetIpv4.IpOption.IsSet)
                if (loadBalancerPublicNetIpv4.IpOption.Value != null)
                    writer.WriteString("ip", loadBalancerPublicNetIpv4.Ip);
                else
                    writer.WriteNull("ip");
        }
    }
    ...
    /// <summary>
    /// The LoadBalancerPublicNetIpv4SerializationContext
    /// </summary>
