...
namespace Hetzner.Cloud.Model
{
    ...
    internal partial class ReplaceFloatingIpRequest : IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplaceFloatingIpRequest {\n");
    ...
    internal class ReplaceFloatingIpRequestJsonConverter : JsonConverter<ReplaceFloatingIpRequest>
    {
        ...
        public override ReplaceFloatingIpRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (labels.IsSet && labels.Value == null)
                throw new ArgumentNullException(nameof(labels), "Property is not nullable for class ReplaceFloatingIpRequest.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ReplaceFloatingIpRequest.");

            return new ReplaceFloatingIpRequest(description, labels, name);
        }

        /// <summary>
        /// Serializes a <see cref="ReplaceFloatingIpRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="replaceFloatingIpRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReplaceFloatingIpRequest replaceFloatingIpRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, replaceFloatingIpRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReplaceFloatingIpRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="replaceFloatingIpRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReplaceFloatingIpRequest replaceFloatingIpRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (replaceFloatingIpRequest.LabelsOption.IsSet && replaceFloatingIpRequest.Labels == null)
                throw new ArgumentNullException(nameof(replaceFloatingIpRequest.Labels), "Property is required for class ReplaceFloatingIpRequest.");

            if (replaceFloatingIpRequest.NameOption.IsSet && replaceFloatingIpRequest.Name == null)
                throw new ArgumentNullException(nameof(replaceFloatingIpRequest.Name), "Property is required for class ReplaceFloatingIpRequest.");

            if (replaceFloatingIpRequest.DescriptionOption.IsSet)
                if (replaceFloatingIpRequest.DescriptionOption.Value != null)
                    writer.WriteString("description", replaceFloatingIpRequest.Description);
                else
                    writer.WriteNull("description");

            if (replaceFloatingIpRequest.LabelsOption.IsSet)
            {
                writer.WritePropertyName("labels");
                JsonSerializer.Serialize(writer, replaceFloatingIpRequest.Labels, jsonSerializerOptions);
            }
            if (replaceFloatingIpRequest.NameOption.IsSet)
                writer.WriteString("name", replaceFloatingIpRequest.Name);
        }
    }

    /// <summary>
    /// The ReplaceFloatingIpRequestSerializationContext
    /// </summary>
