...
inputSpec: hcloud.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{8CB05EA8-7887-4F17-B1BE-79C82C05E6F4}'
...
## Api Information
- appName: Hetzner Cloud API
- appVersion: 0.22.0
- appDescription: Copied from the official API documentation for the Public Hetzner Cloud.
